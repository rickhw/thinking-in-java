...
set JARPATH=%APP_HOME%\lib\googleapi-0.0.1-SNAPSHOT.jar

@rem Execute googleapi
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GOOGLEAPI_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%GOOGLEAPI_EXIT_CONSOLE%" exit 1
exit /b 1
