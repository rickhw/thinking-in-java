...
import com.gtcafe.asimov.platform.tenant.rest.request.UpdateTenantAttributeRequest;
import com.gtcafe.asimov.platform.tenant.rest.response.QueryTenantResponse;
import com.gtcafe.asimov.platform.tenant.rest.response.RetrieveTenantResponse;
import com.gtcafe.asimov.platform.tenant.rest.response.TenantTaskResponse;
import com.gtcafe.asimov.platform.tenant.rest.response.http4xx.TenantHttp400ErrorResponse;
import com.gtcafe.asimov.platform.tenant.rest.response.http4xx.TenantHttp404ErrorResponse;
import com.gtcafe.asimov.platform.tenant.rest.response.http5xx.TenantHttp500ErrorResponse;
import com.gtcafe.asimov.system.HttpHeaderConstants;
import com.gtcafe.asimov.system.response.GlobalHttp401ErrorResponse;
import com.gtcafe.asimov.system.response.GlobalHttp429ErrorResponse;
import com.gtcafe.asimov.system.response.GlobalHttp500ErrorResponse;
