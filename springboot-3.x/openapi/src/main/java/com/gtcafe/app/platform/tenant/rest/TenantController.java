package com.gtcafe.app.platform.tenant.rest;
...
import com.gtcafe.app.platform.tenant.domain.model.TenantState;
import com.gtcafe.app.platform.tenant.rest.message.request.CreateTenantRequest;
import com.gtcafe.app.platform.tenant.rest.message.request.UpdateTenantAttributeRequest;
import com.gtcafe.app.platform.tenant.rest.message.response.QueryTenantResponse;
