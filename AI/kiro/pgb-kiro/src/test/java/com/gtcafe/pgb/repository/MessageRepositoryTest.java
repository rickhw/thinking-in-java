...
class MessageRepositoryTest {
    ...
    class BoardOwnerQueries {
        ...
        void shouldFindMessagesByBoardOwnerExcludingDeletedAndReplies() {
            ...
            Page<Message> messages = messageRepository.findByBoardOwnerAndNotDeletedAndParentMessageIsNull(boardOwner,
                    pageable);
    ...
    class SearchAndFilterQueries {
        ...
        void shouldFindMessagesCreatedAfterSpecificDate() {
            ...
            List<Message> messages = messageRepository.findByBoardOwnerAndCreatedAfterAndNotDeleted(boardOwner,
                    yesterday);
